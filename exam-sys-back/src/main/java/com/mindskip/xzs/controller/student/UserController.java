...
public class UserController extends BaseApiController {
    ...
    public RestResponse<Void> register(@RequestBody @Valid UserRegisterVM model) {
    ...
    public RestResponse<UserResponseVM> update(@RequestBody @Valid UserUpdateVM model) {
        ...
        Integer originalUserLevel = user.getUserGroupId();
        modelMapper.map(model, user);
        user.setUserGroupId(originalUserLevel);
    ...
    public RestResponse<Void> read(@PathVariable Integer id) {
