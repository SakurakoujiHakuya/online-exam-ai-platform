...
public class ExamUtil {
    ...
    /**
     * Content to string string (No Sort).
     *
     * @param contentArray the content array
     * @return the string
     */
    public static String contentToStringNoSort(List<String> contentArray) {
        return contentArray.stream().collect(Collectors.joining(ANSWER_SPLIT));
    }
