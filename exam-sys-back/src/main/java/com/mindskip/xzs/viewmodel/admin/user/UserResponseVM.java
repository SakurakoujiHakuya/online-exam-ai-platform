...
public class UserResponseVM extends BaseVM {
    ...
    public static UserResponseVM from(User user, String userGroupName) {
        ...
        vm.setExcellent(user.getExcellent());
        vm.setComment(user.getComment());
        vm.setUserGroupName(userGroupName);
        return vm;
    }
    ...
    public void setUserLevelName(String userLevelName) {
        this.userGroupName = userLevelName;
    }
