...
public class TaskExamServiceImpl extends BaseServiceImpl<TaskExam> implements TaskExamService {
    ...
    public void edit(TaskRequestVM model, User user) {
        ...
        if (actionEnum == ActionEnum.ADD) {
            ...
            taskExam.setStartTime(DateTimeUtil.parse(model.getStartTime(), DateTimeUtil.STANDER_FORMAT));
            taskExam.setEndTime(DateTimeUtil.parse(model.getEndTime(), DateTimeUtil.STANDER_FORMAT));
    ...
    public TaskRequestVM taskExamToVM(Integer id) {
        ...
        vm.setStartTime(DateTimeUtil.dateFormat(taskExam.getStartTime()));
        vm.setEndTime(DateTimeUtil.dateFormat(taskExam.getEndTime()));
        return vm;
    }

    @Override
    public List<TaskExam> getByUserGroupId(Integer userGroupId) {
        return taskExamMapper.getByGradeLevel(userGroupId);
    }
}
