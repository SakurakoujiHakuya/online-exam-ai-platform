    ...
    public static class FormLoginWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .antMatchers("/api/admin/ai/config/**").hasRole(RoleEnum.ADMIN.getName())
                    .antMatchers("/api/admin/education/**").hasRole(RoleEnum.ADMIN.getName())
                    .antMatchers("/api/admin/user/current").hasAnyRole(RoleEnum.ADMIN.getName(), RoleEnum.TEACHER.getName())
                    .antMatchers("/api/admin/user/delete/**", "/api/admin/user/changeStatus/**").hasRole(RoleEnum.ADMIN.getName())
                    .antMatchers("/api/admin/user/event/**").hasRole(RoleEnum.ADMIN.getName())
                    .antMatchers("/api/admin/user/**").hasAnyRole(RoleEnum.ADMIN.getName(), RoleEnum.TEACHER.getName())
