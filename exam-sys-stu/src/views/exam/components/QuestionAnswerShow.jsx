    ...
    return (
        <div className="q-answer-show" style={{ lineHeight: 1.8 }}>
            ...
            <div className="q-content">
                 {/* Render user's answer (disabled state) */}
                {qType === 1 && (
                ...
                {qType === 4 && (
                    <div>
                        {question.items.map((item, index) => (
                            <Form.Item key={item.prefix} label={item.prefix} style={{ marginBottom: 10 }}>
                                <Input value={answer.contentArray && answer.contentArray[item.prefix - 1]} disabled />
                            </Form.Item>
                        ))}
                    </div>
                )}
